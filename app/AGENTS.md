...
- Prefix the four main content titles inline with `一、` through `四、`; keep the Hero project title and editable project data unnumbered.
...
- Below `700px`, hide the complete event lockup and use `18px` Hero top padding. Below `1020px`, member buttons synchronize the profile card with a five-position portrait spotlight: the surrounding image dims while the selected person remains clear with a subtle cobalt halo.
